...
class AnneAuth::InstallGeneratorTest < Rails::Generators::TestCase
  ...
  test "copies initializer route example and timestamped migrations" do
    ...
    assert_file "app/models/user.rb", /class User < AnneAuth::User/
    assert_migration "create_anne_auth_users.rb"
    assert_migration "create_anne_auth_sessions.rb"
  ...
  test "copies legacy admin migrations when requested" do
    ...
    assert_no_migration "create_anne_auth_users.rb"
    assert_no_migration "create_anne_auth_sessions.rb"

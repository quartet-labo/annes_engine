...
class AnneAuth::RateLimitsTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    AnneAuth.configuration.account_mailer_class_name = "AnneAuth::RateLimitsTest::SilentVerificationMailer"

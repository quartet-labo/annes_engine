...
class AnneAuth::AccountEventsTest < ActionDispatch::IntegrationTest
  CODE = "123456"
  ...
  setup do
    ...
    AnneAuth.configuration.account_mailer_class_name =
      "AnneAuth::AccountEventsTest::RecordingAccountMailer"
  ...
  test "emits invitation sent and accepted events without invitation tokens" do
    sent_events = capture_account_events do
      @delivery_result = AnneAuth::Accounts::InvitationDelivery.call(@unverified)
    end
  ...
  private
    def capture_account_events
      ...
      ActiveSupport::Notifications.subscribed(
        ...
        AnneAuth::AccountEvent::EVENT_NAME
      ) do
        yield
      end

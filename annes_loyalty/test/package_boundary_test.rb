...
class AnnesLoyalty::PackageBoundaryTest < AnnesLoyalty::TestCase
  ...
  test "runtime files do not reference host application domain constants" do
    runtime_files = Dir[
      AnnesLoyalty::Engine.root.join("app/**/*.rb"),
      AnnesLoyalty::Engine.root.join("lib/annes_loyalty/**/*.rb")
    ...
    violations = runtime_files.filter_map do |path|
      ...
      Pathname(path).relative_path_from(AnnesLoyalty::Engine.root).to_s
    end

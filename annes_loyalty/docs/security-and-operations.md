# AnnesLoyalty Security and Operations

Use this checklist before enabling AnnesLoyalty in a production host app.

## Token Handling

- Set `AnnesLoyalty.configuration.token_digest_secret` to a stable production
...
- Treat `LoyaltyLedgerEntry` as append-only. Use `AnnesLoyalty.reverse!` for

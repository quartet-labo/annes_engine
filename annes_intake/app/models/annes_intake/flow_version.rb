module AnnesIntake
  class FlowVersion < ApplicationRecord
    belongs_to :flow, class_name: "AnnesIntake::Flow", inverse_of: :versions
    has_many :steps, -> { order(:position, :id) }, class_name: "AnnesIntake::Step", dependent: :destroy, inverse_of: :flow_version

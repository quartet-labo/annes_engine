module AnnesIntake
  class FormVersion < ApplicationRecord
    belongs_to :form, class_name: "AnnesIntake::Form", inverse_of: :versions
    has_many :fields, -> { order(:position, :id) }, class_name: "AnnesIntake::Field", dependent: :destroy, inverse_of: :form_version

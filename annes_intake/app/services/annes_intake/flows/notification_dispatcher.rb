module AnnesIntake
  ...
  class NotificationDispatcher
    def self.call(id)
      ...
      adapter = AnnesIntake.configuration.adapters[request.run.adapter_flow.key]
      ...
      begin
        ...
        Rails.logger.error("AnnesIntake notification state #{id}: #{state_error.class}")
      end
      Rails.logger.error("AnnesIntake notification #{id}: #{error.class}")
    end

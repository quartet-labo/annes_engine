require_relative "lib/annes_intake/version"

Gem::Specification.new do |spec|
  spec.name = "annes_intake"
  spec.version = AnnesIntake::VERSION
  spec.authors = ["Quartet Labo LLC."]
  spec.summary = "Configurable intake forms and typed answers for Rails"
  spec.homepage = "https://github.com/quartet-labo/annes_engine/tree/main/annes_intake"
  spec.license = "MIT"
  spec.required_ruby_version = ">= 3.4"
  spec.metadata["source_code_uri"] = spec.homepage
  spec.metadata["changelog_uri"] = "https://github.com/quartet-labo/annes_engine/blob/main/annes_intake/CHANGELOG.md"

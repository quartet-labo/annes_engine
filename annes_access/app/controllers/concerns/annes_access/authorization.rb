module AnnesAccess
  module Authorization
    ...
    def current_ability
      @current_ability ||= AnnesAccess.ability_for(current_access_principal)
    end
    ...
    def authorize_access!(action, resource, record: nil)
      ...
      raise AnnesAccess::NotAuthorizedError, "not authorized to #{action} #{resource}"
    end

    def current_access_principal
      resolver = AnnesAccess.configuration.principal_resolver

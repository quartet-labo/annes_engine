module AnnesAuth
  module Accounts
    class InvitationsController < AnnesAuth::ApplicationController
      INVITATION_SESSION_KEY = :annes_auth_account_invitation_id
      ...
      def update
        ...
        result = AnnesAuth::Accounts::InvitationAcceptance.call(
          invitation_token:,
      ...
      private
        def invitation_token_class
          AnnesAuth.configuration.account_invitation_token_class
        end

  ...
  module Accounts
    class BootstrapInvitation
      ...
      def call
        ...
        delivery_result = AnnesAuth::Accounts::InvitationDelivery.call(account)
      ...
      private
          ...
          with_bootstrap_claim_lock do |claim|
            if claim.completed_at.present?
              ...
              if account.save
                ...
                AnnesAuth.configuration.account_bootstrapped(account)
        ...
        def with_bootstrap_claim_lock
          ...
          begin
            bootstrap_claim_class.transaction do
              claim = bootstrap_claim_class.lock.find_by(purpose: AnnesAuth::BootstrapClaim::INITIAL_ACCOUNT_PURPOSE)
              claim ||= bootstrap_claim_class.create!(purpose: AnnesAuth::BootstrapClaim::INITIAL_ACCOUNT_PURPOSE)
              claim.lock!
        ...
        def bootstrap_claim
          @bootstrap_claim ||= bootstrap_claim_class.find_by(purpose: AnnesAuth::BootstrapClaim::INITIAL_ACCOUNT_PURPOSE)
        end

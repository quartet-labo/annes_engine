...
class AnnesAuth::AccountSessionsRedirectTest < ActionDispatch::IntegrationTest
  setup do
    @original_after_account_login_path = AnnesAuth.configuration.after_account_login_path
  ...
  teardown do
    AnnesAuth.configuration.after_account_login_path = @original_after_account_login_path
    AnnesAuth::Current.reset
  end
  ...
  test "redirects verified account from login to configured account path" do
    AnnesAuth.configuration.after_account_login_path =

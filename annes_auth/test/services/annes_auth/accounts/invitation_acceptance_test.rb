...
class AnnesAuth::Accounts::InvitationAcceptanceTest < ActiveSupport::TestCase
  ...
  test "credential invalidation failure rolls back the account update" do
    invitation, = CustomerAccountInvitationToken.issue_for(@account)
    service = AnnesAuth::Accounts::InvitationAcceptance.new(
  ...
  private
    def accept(invitation, password: "new-password-123", password_confirmation: "new-password-123")
      AnnesAuth::Accounts::InvitationAcceptance.call(
        invitation_token: invitation,
        password:,

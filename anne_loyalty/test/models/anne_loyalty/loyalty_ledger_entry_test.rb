...
class AnneLoyalty::LoyaltyLedgerEntryTest < AnneLoyalty::TestCase
  test "records known entry types and idempotency keys" do
    ...
    duplicate = AnneLoyalty::LoyaltyLedgerEntry.new(
      loyalty_member: member,
      loyalty_location: location,
      entry_type: "earn",
      points_delta: 10,
  ...
  test "rejects unknown entry types" do
    entry = AnneLoyalty::LoyaltyLedgerEntry.new(

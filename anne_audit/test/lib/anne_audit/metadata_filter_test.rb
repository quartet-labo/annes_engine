...
class AnneAudit::MetadataFilterTest < AnneAudit::TestCase
  test "normalizes symbols and filters sensitive metadata recursively" do
    filtered = AnneAudit::MetadataFilter.new.call(
      source: :admin,
      nested: {
        reason: :manual,
  ...
  test "uses configured filter keys" do
    ...
    filtered = AnneAudit::MetadataFilter.new.call(api_key: "secret", visible: "value")

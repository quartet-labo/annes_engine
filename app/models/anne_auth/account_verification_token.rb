...
module AnneAuth
  class AccountVerificationToken < ApplicationRecord
    self.table_name = AnneAuth.configuration.account_verification_token_table_name
    ...
    def self.digest_secret
      Rails.application.key_generator.generate_key(AnneAuth.configuration.account_verification_digest_salt, 32)
    end

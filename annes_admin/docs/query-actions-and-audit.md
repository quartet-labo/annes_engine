# AnnesAdmin Queries, Actions, and Audit Events
...
AnnesAdmin applies operations in this order:
...
AnnesAdmin instruments `annes_admin.audit` through
...
```ruby
ActiveSupport::Notifications.subscribe("annes_admin.audit") do |event|
